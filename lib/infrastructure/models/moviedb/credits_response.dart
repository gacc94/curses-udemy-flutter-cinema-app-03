...
class Cast {
  ...
  factory Cast.fromJson(Map<String, dynamic> json) => Cast(
    ...
    gender: json['gender'],
    id: json['id'],
    knownForDepartment: Department.values.firstWhere(
      (e) => e.name == (json['known_for_department'] ?? ''),
      orElse: () => Department.acting, // Default fallback
    ),
    name: json['name'],
    ...
    department: json['department'] != null
        ? Department.values.firstWhere(
            ...
            orElse: () => Department.crew, // Default fallback
          )
        : null,
    job: json['job'],
  );
